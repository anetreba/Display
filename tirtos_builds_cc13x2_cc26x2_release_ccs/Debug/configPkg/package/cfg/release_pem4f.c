 ...
 */
xdc__META(__ASM__, "@(#)__ASM__ = /Volumes/Storage/shared/anetreba/IOT/Display/tirtos_builds_cc13x2_cc26x2_release_ccs/Debug/configPkg/package/cfg/release_pem4f");
